 ...
 * Principal Approval & Review Page Controller with Graphic Signature Pad
 */
...
function renderReportDetails(report) {
  ...
  document.getElementById('p-teacher-supervisor').textContent = `${report.supervisorName || 'אברהם מנחה'} (${report.district || 'מרכז'})`;
