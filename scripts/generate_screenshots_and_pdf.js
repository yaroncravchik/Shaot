...
<body>
  ...
  <div class="page">
    <div class="cover-header">
      ...
      <div class="cover-badge">גרסה 2.1 מעודכנת • חתימה גרפית נגישה • שפת עיצוב ממלכתית Civic Clarity</div>
    </div>

    <div class="card">
      <div class="card-title">אודות המערכת – פשטות שימוש ואבטחה מובנית</div>
      <p>
        מערכת דיווח שעות של"ח (שדה, לאום, חברה) מאפשרת למורי של"ח לדווח על שעות פעילותם מדי חודש.
        <strong>חוויית המשתמש פשוטה וטבעית:</strong> המשתמשים (מורים, מנהלים, מנחים וממונים) ממלאים את הנתונים וחותמים על גבי <strong>משטח חתימה גרפית אינטואיטיבי</strong> (בעכבר או במגע).
        כל מנגנון האבטחה, ההצפנה והחתימה הדיגיטלית (RSA 2048-bit) מנוהל במלואו מאחורי הקלעים על ידי השרת, ללא צורך בהתעסקות טכנולוגית מצד המשתמשים.
      </p>
    </div>
    ...
    <div class="role-grid">
      ...
      <div class="role-box">
        ...
        <p>מקבל קישור ישיר ומאובטח במייל (ללא צורך בלוגין), בודק את הדוח, חותם גרפית ומאשר בלחיצה אחת.</p>
      </div>
      <div class="role-box">
        <div class="role-name">3. מנחה מחוזי (Supervisor)</div>
        <p>רואה את כל מורי המחוז, עורך שעות ישירות בטבלה (מודגשות באדום), מוסיף הערות ומייצא לאקסל.</p>
      </div>
      <div class="role-box">
        <div class="role-name">4. ממונה ארצי - רונן (Super Admin)</div>
        <p>רואה את כלל הדוחות בארץ, חותם גרפית ומבצע אישור סופי לתשלום המנפיק חתימה מאובטחת אוטומטית.</p>
      </div>
    </div>

    <div class="info-callout">
      <strong>סרגל מעבר מהיר לבדיקה (Role Switcher):</strong>
      בראש כל עמוד באתר מוטמע סרגל כחול ייעודי המאפשר לבודק לעבור באופן מיידי בלחיצה אחת בין כל התפקידים (מורה, מנהלת, מנחה מחוזי, ממונה ארצי), ללא צורך בהתנתקות או זכירת סיסמאות!
    </div>
  ...
  <!-- עמוד 5: מסך ממונה רונן ותרחיש בדיקה -->
  <div class="page">
    <div class="section-title">6. מסך ממונה ארצי (רונן - Super Admin) ואישור סופי לתשלום</div>
    <p>
      הממונה הארצי צופה בכלל הדוחות בארץ, מסנן ומבצע בדיקה. בלחיצה על "אישור סופי לתשלום והטבעת חתימה", המערכת קולטת את החתימה הגרפית, ומנפיקה חתימה מאובטחת ברקע.
    </p>
    <div class="screenshot-container">
      <img class="screenshot-img" src="${base64Image('06_admin.png')}" alt="מסך ממונה ארצי">
      <div class="screenshot-caption">תמונה 6: מסך ממונה ארצי, יומן ביקורת, משטח חתימה גרפית וייצוא מאסטר</div>
    </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>השדה שנערך נצבע באדום מודגש והדוח מועבר לממונה הארצי.</td>
        </tr>
        <tr>
          <td>4</td>
